...
🔗 [Accéder à la branche macOS](https://github.com/liljoker06/PixScribeIA/tree/macOS)
...
![Résultat](./assets/screenshot-result.png)

### 🕓 Historique des requêtes
![Historique](./assets/screenshot-history.png)
